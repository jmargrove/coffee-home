...
class UserInput extends Component {
  ...
  renderModelButton() {
    if (true) {
      ...
      return (
        <Link
          to={`/simple-results?lat=${Number(coordObj.lat)}&lng=${Number(
            coordObj.lng
          )}`}
        >
  ...
  renderSoilButton() {
    if (true) {
      ...
      return (
        <Link
          to={`/rainfall?lat=${Number(coordObj.lat)}&lng=${Number(
            coordObj.lng
          )}`}
        >
          ...
          <div className="form-body">
            <Paper className="user-input-frame" zDepth={3}>
              ...
              <div className="user-location-info">
                  ...
                  <div className="coords-box">
                    <div className="userdata-coords">
                      ...
                      <div className="coords">
                        {" "}
                        {Math.round(this.coordObj.lat * 1000) / 1000}
                      </div>
                    </div>
                    <div className="userdata-coords">
                      ...
                      <div className="coords">
                        {" "}
                        {Math.round(this.coordObj.lng * 1000) / 1000}
                      </div>
                    </div>
                  </div>
                  <div className="CR-box">
                    <div className="location-class">Country: </div>
                    <div className="location-var">
                ...
                <div className="location-map">{this.renderMapOnInit()}</div>
                <div />
              </div>
              ...
              <div className="user-irrigation-info">
                <div className="user-data-info">
                  <Checkbox
                    className="user-data-type-check"
              ...
              <div className="additional-local-info">
                <div className="model-button">{this.renderModelButton()}</div>
              </div>
            </Paper>
          </div>
        </div>
